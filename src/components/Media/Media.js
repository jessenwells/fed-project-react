   ...
   <div className='container-fluid'>
    <div className='col-lg-10 mx-auto px-0'>
     ...
     <p className='media-content mb-4 col-md-8 mx-auto'>
      ...
      missions is to build 100 schools in Africa. Check out the video below to learn more about our{' '}
      <span className='media-content-link'>#builtwithbitcoin</span> initiative.
     </p>
     ...
     <div className='media-slider mb-6'>
      <Slider {...settings}>
       {logos.map((logo) => (
        <div className='media-slider-slide-container'>
         <a href='?' className='media-slider-slide'>
          <img src={`/assets/${logo}.png`} alt={logo} className='media-logo' />
         </a>
        </div>
       ))}
      </Slider>
