...
<div className="container-fluid">
   <div className='col-lg-10 mx-auto px-0'>
    <article className='start-container text-center'>
     ...
     <p className='start-content mb-4 col-md-8 mx-auto'>Sign up today to receive your free digital wallet. You can immediately start buying or selling bitcoin, hassle-free.</p>
     <p className='mb-0'>
